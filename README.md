...
打开终端，进入项目目录： Copy code to clipboard cd d:\project\giveme
安装依赖： Copy code to clipboard python -m pip install -r requirements.txt
启动 Demo： Copy code to clipboard python -m streamlit run app.py
